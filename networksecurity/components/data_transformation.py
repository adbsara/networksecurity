...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransfromationArtifact:
        ...
        try:
            ...
            data_transformation_artifact=DataTransfromationArtifact(
                transformed_object_file_path=self.data_transformation_config.transformed_object_file_path,
                transformed_train_file_path=self.data_transformation_config.transformed_train_file_path,
                transformd_test_file_path=self.data_transformation_config.transformed_test_file_path
            )
