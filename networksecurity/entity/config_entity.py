...
class DataValidationConfig():
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        training_pipeline_config.artifact_dir,training_pipline.DATA_VALIDATION_DIR_NAME)
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.trained_model_file_path: str = os.path.join(
            self.model_trainer_dir, training_pipline.MODEL_TRAINER_TRAINED_MODEL_DIR, 
            training_pipline.MODEL_FILE_NAME
        )
        self.expected_accuracy: float = training_pipline.MODEL_TRAINER_EXPECTED_SCORE
        self.overfitting_underfitting_threshold = training_pipline.MODEL_TRAINER_OVER_FIITING_UNDER_FITTING_THRESHOLD
